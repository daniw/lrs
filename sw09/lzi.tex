...
\begin{figure}[h!]
    \centering
    \begin{tikzpicture}[xscale=0.2, yscale=0.04, domain=0:21]
        \draw [->] (0,0) -- (21,0) node[below] {$\omega$};
        \draw [->] (0,-60) -- (0,20) node[left] {$A$};
    \end{tikzpicture}
    \begin{tikzpicture}[xscale=0.2, yscale=0.02, domain=0:21]
        \draw [->] (0,0) -- (21,0) node[below] {$\omega$};
        \draw [->] (0,-180) -- (0,10) node[left] {$\varphi$};
    \end{tikzpicture}
\end{figure}
